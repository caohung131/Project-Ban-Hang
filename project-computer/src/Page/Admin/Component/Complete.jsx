      ...
      <div>
        ...
        <table className="table">
          {dataNew.map((itemt, index) => (
            <tr className="trTodoapp"> 
              <td id={index} className="valueShow">
                <Checkbox
              ...
              <td><Button className="buttonComplete" danger type="primary" onClick={handleDeleteOne}  id={itemt.id}><DeleteOutlined id="deleteicont"/></Button></td>
            </tr>
          ))}
          <tr>
            <td>
              <Button className="buttonComplete" type="primary" danger onClick={deleteAll}><DeleteOutlined />
                Delete all
              </Button>
